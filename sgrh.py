...
class Pessoa:
    def __init__(self, nome, cpf, endereco, profissao):
        ...
        self.profissao = profissao  # Novo atributo

    def __repr__(self):
        return f'Pessoa(nome={self.nome}, cpf={self.cpf}, endereco={self.endereco}, profissao={self.profissao})'
...
def criar():
    ...
    profissao = request.form['profissao']  # Captura a profissão

    nova_pessoa = Pessoa(nome, cpf, endereco, profissao)

# Passa a profissão para a nova instância
